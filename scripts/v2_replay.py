...
columns_mapping = {
    "isoTimestamp": "ts",
    "FH.6000.[ENS] - Energy Signals.Momentary power consumption W": "momentary_power_consumption",
    ...
    "FH.6000.[LED] LED STATUS.LED RGB Strip 1 (left) - Red": "led_rgb_strip_1_left_r",
    "FH.6000.[LED] LED STATUS.LED RGB Strip 2 (right) – Red": "led_rgb_strip_2_right_r",
    "FH.6000.[LED] LED STATUS.LED RGB Strip 1 (left) – Green": "led_rgb_strip_1_left_g",
    "FH.6000.[LED] LED STATUS.LED RGB Strip 2 (right) – Green": "led_rgb_strip_2_right_g",
    "FH.6000.[LED] LED STATUS.LED RGB Strip 1 (left) – Blue": "led_rgb_strip_1_left_b",
    "FH.6000.[LED] LED STATUS.LED RGB Strip 2 (right) – Blue": "led_rgb_strip_2_right_b",
    ...
    'FH.6000.[NNS] - Natural Navigation Signals.Difference heading average correction': 'nn_diff_heading_avg_correction',
    'FH.6000.[NNS] - Natural Navigation Signals.Distance average correction': 'nn_distance_avg_correction',
}
...
casting_mapping = {
    ...
    "nn_diff_heading_avg_correction": float,
    "nn_distance_avg_correction": float,
}
